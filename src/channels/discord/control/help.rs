...
mod tests {
    ...
    fn every_command_the_bot_registers_is_explained() {
        ...
        for needed in ["help", "today", "mypoints", "housetop", "fight", "battle", "quiz", "snitchdrop", "frogdrop", "frogs", "frogcard", "trade", "trades", "sellset", "panel", "guiderefresh", "npatstop", "sudoku", "sudokuhelp", "sudokunew", "chess", "chesshelp", "chessstop", "anagram", "anagramhelp", "anagramskip", "anagramstop"] {
