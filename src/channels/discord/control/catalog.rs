    ...
    vec![
        ...
        Section {
            ...
            settings: vec![
                ...
                setting("VIZIER_NPAT_POPUP_TIMER", "Live timer inside the pop-up", "Show a live countdown line inside the answers pop-up. Off by default: that newer pop-up block has crashed some Discord apps. The pop-up title always shows the seconds left.", Kind::Toggle, "off"),
